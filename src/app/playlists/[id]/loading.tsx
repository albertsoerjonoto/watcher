  ...
  return (
    <section className="space-y-4">
      <div className="flex items-start gap-4">
        <div className="h-20 w-20 shrink-0 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />
        <div className="flex-1 space-y-2">
          ...
          <div className="h-3 w-1/4 animate-pulse rounded bg-neutral-100 dark:bg-neutral-900" />
        </div>
      </div>
